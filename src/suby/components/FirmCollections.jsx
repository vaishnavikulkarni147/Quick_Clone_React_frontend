...
const FirmCollections = () => {
  ...
  return (
    <>
      <h3>Restaurants with online food delivery in Vijayapura</h3>
      <div className="filterButtons">
        ...
        <button onClick={() => filterHandler("Appetizers", 'appetizers')} className={activeCategory === 'Appetizers' ? 'activeButton': ''} >Appetizers</button>
        <button onClick={() => filterHandler("Beverages", 'beverages')} className={activeCategory === 'Beverages' ? 'activeButton': ''} >Beverages</button>
      </div>
